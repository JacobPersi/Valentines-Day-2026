...
export const Icon: React.FC<IconProps> = ({ name, className = "w-5 h-5" }) => {
  const icons: Record<string, string> = {
    ...
    Sparkles: `<path d="m12 3 1.912 4.088L18 9l-4.088 1.912L12 15l-1.912-4.088L6 9l4.088-1.912L12 3Z"/><path d="M5 3 6 5l2 1-2 1-1 2-1-2-2-1 2-1 1-2Z"/><path d="M19 16l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2Z"/>`,
